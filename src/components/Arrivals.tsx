    ...
    return(
        ...
        <div className="flex justify-around gap-2 ml-3 mt-7 md:gap-0">
            ...
            <div className="text-sm font-bold flex gap-4 md:justify-around lg:text-lg">
                <p className=" ml-2 mt-3 xs:ml-4 smCustom:ml-5 sm:ml-20 md:-ml-5 xl:-ml-8">T-Shirt with Tape Details</p>
                <p className="mt-3 xs:ml-3 smCustom:ml-10 sm:ml-40 md:-ml-14 xl:-ml-20">Skinny Fit Jeans </p>
            ...
            <div className="flex font-bold text-lg">
                <p className="ml-3 xs:ml-4 smCustom:ml-5 sm:ml-20 md:ml-3 lg:ml-8 xl:ml-14">$120</p>
                <p className="ml-32 xs:ml-36 smCustom:ml-44 sm:ml-72 md:ml-36 lg:ml-52 xl:ml-72">$240</p>
                <s className="text-gray-400 ml-1 xs:ml-3">$260</s>
                <button className="border-red-200 rounded-full w-10 h-5 text-xs bg-red-200 text-red-700 ml-2 mt-1 
                font-extrabold">-20%
                </button>
                <p className="hidden md:block ml-14 lg:ml-32 xl:ml-52">$180</p>
                <p className="hidden md:block ml-36 lg:ml-52 xl:ml-72">$130</p>
            ...
            <Link href="/Detail.tsx">
               <Image className="w-36 h-36 ml-3 border rounded-xl smCustom:w-40 smCustom:h-40 sm:w-48 sm:h-44 md:w-44 md:h-44 
            ...
            <div className="text-sm font-bold flex gap-3 mt-4 md:gap-11 lg:justify-around lg:text-base">
                <p className="ml-2 xs:ml-6 smCustom:ml-7 sm:ml-16 md:ml-4 xl:ml-0">Vertical Striped Shirt</p>
                <p className="ml-9 smCustom:ml-16 sm:ml-44 md:ml-0 lg:ml-5 xl:ml-0"> Courage Graphic T-Shirt</p>
                <p className="hidden md:block xl:-ml-4">Loose Fit Bermuda Shorts</p>
                <p className="hidden md:block lg:mr-12">Faded Skinny Jeans</p>
            </div>
            {/* image 1 ratings */}
            <div className="text-yellow-400 flex ml-2 xs:ml-6 smCustom:ml-7 sm:ml-16 md:ml-4 lg:ml-8 xl:ml-16">
                ...
                <p className="text-gray-400 text-sm mt-1">5</p>
                {/* image 2 ratings */}
                <p className="ml-12 xs:ml-20 smCustom:ml-24 sm:ml-52 md:ml-16 lg:ml-36 xl:ml-56">★</p>
                <p>★</p>
                <p>★</p>
                <p>★</p>
            ...
            <div className="flex font-bold text-lg">
                {/* image 1 price */}
                <p className="ml-2 xs:ml-6 smCustom:ml-7 sm:ml-16 md:ml-3 lg:ml-7 xl:ml-16">$212</p>
                ...
                mt-1 ml-2">-20%</button>
                {/* image 2 price */}
                <p className="ml-5 xs:ml-11 smCustom:ml-16 sm:ml-44 md:ml-9 lg:ml-28 xl:ml-48">$145</p>
                {/* image 3 price */}
        ...
        xs:w-80 sm:w-96 md:w-[600px] md:h-[450px] md:flex-row-reverse lg:w-[850px] lg:h-[500px] xl:w-[1200px] xl:h-[630px] 
        overflow-y-hidden">
        ...
        <div className="relative mt-44">
                ...
                <Image className="h-40 w-64 mx-auto -mt-40 rounded-xl md:ml-[360px] md:w-52 md:h-36 md:-mt-[320px] lg:ml-[530px] lg:h-44 lg:w-60 
        ...
        <div className="mt-9 flex overflow-x-hidden ">
                ...
                lg:ml-24 xl:text-5xl">OUR HAPPY CUSTOMERS</h1>
        ...
        <div className="flex">
            <h1 className="text-sm font-bold ml-8 mt-2 xs:ml-7">Sarah M.</h1>
        ...
        <div className="flex">
            <h1 className="text-sm font-bold ml-8 mt-2 xs:ml-7"> Alex K.</h1>
            <FaCheckCircle className="text-green-600 mt-2 ml-1" />
        </div>
            <p className="text-gray-600 text-sm mx-7 mt-1 font-sans xs:mx-6">
            ...
            <div className="flex">
            <h1 className="text-sm font-bold ml-8 mt-2 xs:ml-7">James L.</h1>
            <FaCheckCircle className="text-green-600 mt-2 ml-1" />
            </div>
            <p className="text-gray-600 text-sm mx-7 mt-1 font-sans xs:mx-6">
