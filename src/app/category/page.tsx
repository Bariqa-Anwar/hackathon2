...
export default function Casual () {
    return (
        ...
        <hr className="w-[20.7rem] ml-6 mx-auto mt-2 sm:w-[37.7rem] sm:ml-3 md:w-[44rem] md:ml-6 lg:w-[56rem] lg:ml-[5rem] xl:w-[70rem] xl:ml-[6rem]">
        </hr>
           <div className="lg:hidden">
            {/* the filters bar */}
           <Sheet>
  <SheetTrigger asChild>
  <button className=" border-gray-200 bg-gray-200 hover:bg-black hover:text-white rounded-full h-8 w-8 ml-[20.4rem] mt-8 
  sm:ml-[580px] md:ml-[43rem] lg:hidden">
  ...
  <div className="grid grid-cols-3 mt-1 gap-y-1.5 ml-5 sm:ml-6">
    ...
    h-8 w-20 sm:w-36 md:w-44">X-Small</button>
    <button className="border-gray-200 text-gray-500 bg-gray-200 hover:bg-black hover:text-white rounded-full text-sm 
    h-8 w-20 sm:w-36 md:w-44">Small</button> 
    <button className="border-gray-200 text-gray-500 bg-gray-200 hover:bg-black hover:text-white rounded-full text-sm 
    h-8 w-20 sm:w-36 md:w-44">Medium</button>
    <button className="border-gray-200 text-gray-500 bg-gray-200 hover:bg-black hover:text-white rounded-full text-sm 
    h-8 w-20 sm:w-36 md:w-44">Large</button>
    <button className="border-gray-200 text-gray-500 bg-gray-200 hover:bg-black hover:text-white rounded-full text-sm 
    h-8 w-20 sm:w-36 md:w-44">X-Large</button>
    <button className="border-gray-200 text-gray-500 bg-gray-200 hover:bg-black hover:text-white rounded-full text-sm 
    h-8 w-20 sm:w-36 md:w-44">XX-Large</button>
    </div>
    <button className="border-gray-200 text-gray-500 bg-gray-200 hover:bg-black hover:text-white rounded-full text-xs 
  h-9 w-48 mt-2 ml-16 sm:w-80 sm:ml-[8.5rem] md:ml-[10rem] md:w-96">
  Apply Filter
  </button>
  </SheetContent>
</Sheet>
  ...
  Apply Filter
                         ...
                         {/* first three images */}
                         <div className="flex justify-around mx-2 mt-5 lg:ml-0 lg:mr-3 lg:mt-5 xl:mr-0 xl:ml-5 xl:gap-9">
                          <Image className="w-36 h-36 border rounded-xl sm:w-44 sm:h-44 md:w-52 md:h-52 lg:h-48 lg:w-48 xl:h-64 xl:w-64"
                          src="/images/shirt2.png"
                          alt="shirt"
                          height={800} 
                          width={800}
                          />
                          <Image className="border rounded-xl h-36 w-36 sm:w-44 sm:h-44 md:w-52 md:h-52 lg:h-48 lg:w-48 xl:h-64 xl:w-64"
                        ...
                        <h1 className="ml-4 sm:ml-12 md:ml-20 lg:ml-14 xl:ml-[5.6rem]">Polo with Tipping Details</h1>
                        <h1 className="hidden sm:block ml-11 md:ml-[4rem] lg:ml-[3rem] xl:ml-[5rem]">Black Striped T-shirt</h1>
                        </div>
                        ...
                        <div className="flex text-yellow-500 ml-[6rem] sm:ml-[130px] md:ml-[165px] lg:ml-[140px] xl:ml-[195px]">
                                   <FaStar className="size-3 md:size-4"/>
                                   <FaStar className="size-3 md:size-4"/>
                                   <FaStar className="size-3 md:size-4"/>
                                   <FaStar className="size-3 md:size-4"/>
                        ...
                        <div className="flex text-yellow-500 ml-[8.6rem] sm:ml-[7.3rem] md:ml-[8.3rem] lg:ml-[7.7rem] xl:ml-[11.2rem]">
                        ...
                        <p className="ml-9 sm:ml-[10.8rem] md:ml-[13.8rem] lg:ml-[12rem] xl:ml-[15.2rem]">$180</p>
                        <s className="text-gray-400 ml-1 sm:hidden">$242</s>
                        <button className="border-red-200 rounded-full w-12 h-5 text-xs bg-red-100
                        text-red-900 font-light mt-1 ml-2 smCustom:mr-3 sm:hidden ">-20%</button>
                        <p className="hidden sm:block ml-[10.7rem] md:ml-52 lg:ml-48 xl:ml-[14.9rem]">$120</p>
                        ...
                        {/* Second last images */}
                        <div className="flex justify-around mx-2 mt-4 sm:ml-4 xl:ml-6 xl:gap-8">
                        <Image className="w-36 h-36 border rounded-xl sm:hidden"
                        src="/images/shirt4.png"
                        alt="jeans" height={700} width={700}/>
                        <Image className="w-36 h-36 border rounded-xl sm:w-44 sm:h-44 sm:-ml-2 md:w-52 md:h-52 lg:h-48 lg:w-48 
                        xl:h-64 xl:w-64"
                        ...
                        <div className="flex font-semibold text-sm justify-around mt-2 md:text-base xl:text-lg">
                <p className="-ml-2 sm:hidden">Black Striped T-shirt</p>
                <p className="mr-9 sm:-ml-7 md:-ml-[2.4rem] lg:-ml-[2rem] xl:-ml-[3.4rem]">Skinny Fit Jeans</p>
                <p className="hidden sm:block -ml-9 md:-ml-4 lg:-ml-6 xl:-ml-4">Checkered Shirt</p>
                <p className="hidden sm:block -mr-1">Sleeve Striped T-Shirt</p>
                        </div>
                        <div className="flex mt-1">
                        ...
                        <div className="flex text-yellow-500 ml-[6.5rem] sm:ml-2 lg:ml-1.5">
                                   <FaStar className="size-3 md:size-4"/>
                                   <FaStar className="size-3 md:size-4"/>
                                   <FaStar className="size-3 md:size-4"/>
                                   <FaStarHalf className="size-3 md:size-4"/>
                        ...
                        <div className="flex text-yellow-500 sm:ml-[8.4rem] md:ml-[10.6rem] lg:ml-[9.1rem] xl:ml-[12rem]">
                        ...
                        <div className="flex text-yellow-500 ml-[8rem] sm:ml-[7.5rem] md:ml-[8.4rem] lg:ml-[7.6rem] xl:ml-[11.5rem]">
                                   <FaStar className="hidden sm:block size-3 md:size-4"/>
                                   <FaStar className="hidden sm:block size-3 md:size-4"/>
                                   <FaStar className="hidden sm:block size-3 md:size-4"/>
                                   <FaStar className="hidden sm:block size-3 md:size-4"/>
                        ...
                        <p className="-ml-1 sm:hidden">$120</p>
                        ...
                        font-light sm:hidden">
                          -30%</button>
                        <p className="ml-14 sm:ml-1 lg:ml-1.5">$240</p>
                        <s className="text-gray-400 ml-1">$260</s>
                        <button className="border-red-200 rounded-full w-12 h-5 text-xs bg-red-100 text-red-900 ml-1 mt-1 
                        font-light">
                          -20%</button>  
                        <p className="hidden sm:block ml-[4.7rem] md:ml-[8.2rem] lg:ml-[5.4rem] xl:ml-[7rem]">$180</p>
                        <p className="hidden sm:block ml-44 sm:ml-[10.6rem] md:ml-[13.2rem] lg:ml-[11.5rem] xl:ml-[15rem]">$130</p>
                        ...
                        {/* last images */}
                        <div className="flex justify-around mx-2 mt-4 sm:ml-3 lg:ml-2 xl:ml-5 xl:gap-8 xl:text-lg">
                          <Image className="w-36 h-36 border rounded-xl sm:hidden"
                          src="/images/arrival3.png" 
                        ...
                        <p className="sm:hidden ml-2">Checkered Shirt</p>
                        <p className="sm:hidden ml-[4.5rem]">Sleeve Striped T-Shirt</p>
                        <p className="hidden sm:block ml-3 lg:ml-3">Vertical Striped Shirt</p>
                        <p className="hidden sm:block ml-[4.6rem] md:ml-[6.6rem] lg:ml-20 xl:ml-[7rem]"> Courage Graphic T-Shirt</p>
                        <p className="hidden sm:block ml-11 md:ml-16 lg:ml-8 xl:ml-[5.5rem]">Loose Fit Bermuda Shorts</p>
                        </div>
                        <div className="flex">
                        <div className="flex text-yellow-500 ml-4 mt-1">
                        ...
                        <div className="flex text-yellow-500 ml-[5.5rem] mt-1">
                                   <FaStar className="sm:hidden size-3"/>
                                   <FaStar className="sm:hidden size-3"/>
                                   <FaStar className="sm:hidden size-3"/>
                                   <FaStar className="sm:hidden size-3"/>
                        ...
                        <div className="flex text-yellow-500 mt-1 -ml-[5.3rem] lg:">
                                   <FaStar className="hidden sm:block size-3 md:size-4"/>
                                   <FaStar className="hidden sm:block size-3 md:size-4"/>
                                   <FaStar className="hidden sm:block size-3 md:size-4"/>
                                   <FaStar className="hidden sm:block size-3 md:size-4"/>
                        ...
                        <div className="flex text-yellow-500 mt-1 ml-[7.5rem] md:ml-[9.6rem] lg:ml-[8rem] xl:ml-[11.2rem]">
                                   <FaStar className="hidden sm:block size-3 md:size-4"/>
                                   <FaStar className="hidden sm:block size-3 md:size-4"/>
                                   <FaStar className="hidden sm:block size-3 md:size-4"/>
                                   <FaStar className="hidden sm:block size-3 md:size-4"/>
                        ...
                        <div className="flex text-yellow-500 mt-1 ml-[9rem] sm:ml-[8.2rem] md:ml-[9.4rem] lg:ml-[7.4rem] xl:ml-[12.5rem]">
                                   <FaStar className="hidden sm:block size-3 md:size-4"/>
                                   <FaStar className="hidden sm:block size-3 md:size-4"/>
                                   <FaStar className="hidden sm:block size-3 md:size-4"/>
                        ...
                        <p className="sm:hidden ml-4">$180</p>
                        <p className="ml-36 sm:hidden">$130</p>
                        ...
                        <p className="hidden sm:block ml-5 lg:ml-5">$212</p>
                        ...
                        <p className="hidden sm:block ml-[5.4rem] md:ml-[8.9rem] lg:ml-[6rem] xl:ml-[8rem]">$145</p>
                        <p className="hidden sm:block ml-44 md:ml-[13.5rem] lg:ml-[11rem] xl:ml-[15.2rem]">$80</p>
                        </div>
                        ...
                        <Link href="/detail">
                          ...
                          <button className="hover:bg-gray-200 bg-white text-gray-500 rounded-lg h-8 w-8 ml-7 sm:ml-9 md:ml-24
                          lg:ml-20 xl:ml-36">
                          1</button>
                          ...
                          10</button>
                          <Link href="/detail">
                          <button className="border border-gray-200 hover:bg-gray-200 bg-white rounded-lg h-8 w-14 ml-8 pr-4
