    ...
    return (
        ...
        <div className="overflow-x-hidden max-w-screen-2xl mx-auto">
           ...
           lg:ml-[420px] xl:ml-[540px]">
            ...
            <div className="flex font-bold text-sm ml-4 mt-3 sm:ml-32 md:text-base md:ml-40 lg:text-lg lg:gap-6 lg:mx-0 xl:gap-12 xl:ml-16">
                    <h1 className="lg:ml-11 xl:ml-14">Polo with Contrast Trims</h1>
                    <h1 className="ml-12 lg:ml-1 xl:ml-7"> Gradient Graphic T-shirt </h1>
            ...
            <div className="flex">
            <div className="flex text-yellow-500 ml-4 mt-2 sm:ml-32 md:ml-40 lg:ml-10 lg:gap-1 xl:ml-28">
           ...
           <div className="flex text-yellow-500 ml-[7.3rem] mt-2 md:ml-[8.5rem] lg:ml-32 lg:gap-1 xl:ml-44">
           <FaStar className="size-3 md:size-4"/>
           <FaStar className="size-3 md:size-4"/>
           <FaStar className="size-3 md:size-4"/>
           <FaStar className="size-3 md:size-4"/>
           ...
           <p className="ml-4 sm:ml-32 md:ml-40 lg:ml-11 xl:ml-28">$212</p>
            ...
            mt-1 ml-2">-20%</button>
            <p className="ml-[3.7rem] md:ml-[6.5rem] xl:ml-36"> $145 </p>
