...
export default function Cart (){
    return(
        ...
        <main className="overflow-x-hidden max-w-screen-2xl mx-auto">
            <hr></hr>
        <div className="flex text-sm font-light ml-6 gap-1 mt-4 lg:ml-20">
            <Link href="/"><h1 className="text-gray-600">Home</h1></Link>
            <ChevronRight className="text-gray-600 size-4 mt-0.5"/>
            <h1>Cart</h1>
        </div>
        <h1 className="text-4xl font-sans font-extrabold ml-6 mt-3 lg:text-5xl lg:ml-20">YOUR CART</h1>
            {/* Images with details */}
            <div className="lg:flex lg:justify-between">
            <div className="flex flex-col container border border-gray-200 rounded-2xl w-80 h-[470px] ml-6 mt-4 sm:w-[595px] 
            sm:h-[530px] md:w-[730px] md:h-[620px] lg:w-[600px] lg:h-[440px] lg:ml-20 xl:w-[720px]">
                <div className="flex">
                <div>
                    ...
                    <RiDeleteBin6Fill className=" text-red-600 size-5 ml-[140px] sm:ml-[23.9rem] md:size-6 md:ml-[465px] md:-mt-8 
                    lg:size-5 lg:ml-[380px] lg:-mt-6 xl:ml-[550px]"/>
                    <div className="flex text-xs mt-1 md:text-sm lg:text-xs xl:">
                    <p>Size:</p> 
                    ...
                    <button className="border-gray-200 flex items-center justify-center gap-3 bg-gray-200 hover:bg-black
                     hover:text-white rounded-full text-xs h-6 w-20 px-1 ml-[80px] -mt-6 sm:ml-[20rem] md:h-9 md:w-32 md:flex md:justify-around
                     md:-mt-8 md:ml-[360px] md:text-sm lg:h-7 lg:w-28 lg:ml-72 xl:ml-[460px]">
            <FiMinus/>1<FaPlus /></button>
                ...
                <div>
                    ...
                    <RiDeleteBin6Fill className=" text-red-600 size-5 ml-[140px] -mt-5 sm:ml-[23.9rem] md:size-6 md:ml-[465px] md:-mt-8 
                    lg:size-5 lg:ml-[380px] lg:-mt-6 xl:ml-[550px]"/>
             ...
             rounded-full text-xs h-6 w-20 px-1 ml-[80px] -mt-6 sm:ml-[20rem] md:h-9 md:w-32 md:flex md:justify-around md:-mt-8 md:ml-[360px] md:text-sm
            ...
            <div className="lg:flex">
                <div className="container border border-gray-200 rounded-2xl w-80 h-[320px] ml-6 mt-4 sm:w-[610px] md:w-[730px] md:h-[340px] 
                lg:h-[320px] lg:w-80 lg:mr-12 xl:mr-32 xl:w-96">
                    ...
                    <hr className="w-72 mx-auto mt-4 sm:w-[550px] lg:w-72 xl:w-80"></hr>
                    <div className="flex justify-between mx-3 mt-4 md:text-xl lg:text-lg">
                        <p className="font-light">Total</p>
                        <p className="font-bold">$467</p>
                    </div>
                    <div className="flex gap-2 mt-5 ml-6 md:flex md:ml-0 lg:gap-0">
                    <MousePointer2 className="size-4 text-gray-400 absolute left-[3.2rem] mt-3 sm:left-16 md:size-5 md:left-12 md:mt-2
                    lg:size-4 lg:left-[680px] xl:left-[860px]"/>
                        ...
                        h-10 w-36 px-4 placeholder:text-sm focus:outline-none focus:ring focus:ring-gray-200 sm:pl-9 sm:w-[18rem] md:w-[750px] 
                        md:ml-3 md:placeholder:text-base lg:w-48 lg:h-9 lg:placeholder:text-sm lg:pl-7
                        xl:w-56"
                        type="text"
                        placeholder="Add promo code"/>
                        <button className="border-gray-200 text-gray-500 bg-gray-200 hover:bg-black hover:text-white rounded-full text-sm 
                        h-10 w-24 ml-6 sm:w-60 md:w-56 md:text-base md:mr-3 lg:text-sm lg:w-24 lg:h-9 xl:w-28">
                            Apply
                        </button>
                    </div>
                    <button className="flex gap-1 border-gray-200 bg-gray-200 hover:bg-black hover:text-white rounded-full text-sm
                    h-10 w-[270px] mt-3 mx-auto text-gray-500 pl-20 py-3 sm:w-[35rem] sm:pl-52 md:w-[700px] md:h-12 md:text-base 
                    md:pl-[17rem] lg:w-[295px] lg:h-9 lg:pl-20 lg:text-sm lg:py-2 xl:w-[360px] xl:px-28">
